package form;
public class MainiForm extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainiForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
